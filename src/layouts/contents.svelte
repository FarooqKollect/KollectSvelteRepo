            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-9">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Mortgage</p>
                                <h5 class="font-weight-bolder text-danger mb-0">
                                    RM 53,000 

                                </h5>
                                <span class="text-secondry text-xs font-weight-bolder">
                                    New Installment: 21/04/2022<br>
                                    For RM2500
                                </span>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-9">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Credit Card</p>
                                <h5 class="font-weight-bolder mb-0 text-danger">
                                    RM 2,300

                                </h5>
                                <span class="text-secondry text-xs font-weight-bolder">
                                    Next Billing: 21/04/2022<br>
                                </span><br>
                            </div>
                        </div>
                        <div class="col-3 text-end">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-9">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Personal Loan</p>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-9">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold ">Hire Purchase</p>
                                <h5 class="font-weight-bolder mb-0 text-success">
                                    RM 103,430
                                </h5>
                                <span class="text-secondry text-xs font-weight-bolder">
        ...
        <div class="col-lg-8 mb-lg-0 mb-4">
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-lg-12">
                            <h5 class="font-weight-bolder">Payment Commitment</h5><br>
                            <div class="d-flex flex-column h-100">
                                <!-- <p class="mb-1 pt-2 text-bold">Built by developers</p> -->

                                <div class="row" style="margin-left: 10%;">
                                    <select name="" class="form-control col-lg-4 mb-lg-0"
                                        style="width: 20%; height: 3em;">
                                        <option value="">Select All</option>
                                        <option value="">Credit Card</option>
                                        <option value="">Mortgage</option>
                                    </select>
                                    <input type="text" value="RM 9000"
                                        style="width: 20%; margin-left: 2%; height: 3em;"
                                        class="form-control col-lg-2">
                                    <input type="date" style="width: 20%; margin-left: 2%; height: 3em;"
                                        class="form-control col col-lg-1">
                                    <a href="#" style="width: 20%; margin-left: 2%;"
                                        class="btn btn-primary form-control col col-lg-1 col-xs-12">Commit
                                        Now</a>
                                </div>
                                <div class="row" style="margin-left: 10%;">
                                    <select name="" class="form-control col-lg-4 col-xs-12"
                                        style="width: 20%; height: 3em;">
                                    ...
                                    <input type="text" value="RM 9000"
                                        ...
                                        class="form-control col-lg-2">
                                    <input type="date" style="width: 20%; margin-left: 2%; height: 3em;"
                                        class="form-control col col-lg-1" value="27/08/2022">
                                    <a href="#" style="width: 20%; margin-left: 2%;"
                                        class="btn btn-primary form-control col col-lg-1 col-xs-12">Commit
                                        Now</a>
                                </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                        ...
                        Total Principle: RM 150,000<br>
                        Total Intrest: RM 45,000<br>
                        Total Outstanding: RM 195,000<br>
                        Total Due: RM 110,000<br>
                        Last Payment: 12 Apr 2022 (RM 20,000)
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <a href="#" class="btn btn-primary">Mortage</a>
                    <a href="#" class="btn btn-primary">Credit Card</a>
                    <a href="#" class="btn btn-primary">All Transactions</a>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2">
                                            ...
                                            <div class="my-auto">
                                                <h6 class="mb-0 text-sm">01/03/2022</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0">1234</p>
                                    </td>
                                    <td>
                                        <span class="text-xs font-weight-bold">RM 10,00</span>
                                    </td>
                                    <td>
                                        <span class="text-xs font-weight-bold">RM 2,000</span>
                                    </td>
                                    <td>
                                        <span class="text-xs font-weight-bold">RM 12,000</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2">
                                            ...
                                            <div class="my-auto">
                                                <h6 class="mb-0 text-sm">01/04/2022</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0">5678</p>
                                    </td>
                                    <td>
                                        <span class="text-xs font-weight-bold">RM 10,00</span>
                                    </td>
                                    ...
                                    <td>
                                        <span class="text-xs font-weight-bold">RM 0</span>
                                    </td>
                                    <td class="align-middle text-center">
                                        <div class="d-flex align-items-center justify-content-center">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2">
                                            ...
                                            <div class="my-auto">
                                                <h6 class="mb-0 text-sm">01/05/2022</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0">9810</p>
                                    </td>
                                    <td>
                                        <span class="text-xs font-weight-bold">RM 10,00</span>
                                    </td>
                    ...
                    <div class="container border-radius-lg">
                        <div class="row">
                            ...
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder">435MYR </h4>
                                <div class="progress w-75">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <span class="text-xs font-weight-bold"> MYR 14,000 </span>
                                    </td>
                                    <td class="align-middle">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <span class="text-xs font-weight-bold"> MYR 3,000 </span>
                                    </td>
                                    <td class="align-middle">
                                        <div class="progress-wrapper w-75 mx-auto">
                                            <div class="progress-info">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <span class="text-xs font-weight-bold"> MYR 20,500 </span>
                                    </td>
                                    <td class="align-middle">
                                        <div class="progress-wrapper w-75 mx-auto">
                                            <div class="progress-info">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <span class="text-xs font-weight-bold"> MYR 500 </span>
                                    </td>
                                    <td class="align-middle">
                                        <div class="progress-wrapper w-75 mx-auto">
                                            <div class="progress-info">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <span class="text-xs font-weight-bold"> MYR 2,000 </span>
                                    </td>
                                    <td class="align-middle">
                                        <div class="progress-wrapper w-75 mx-auto">
                                            <div class="progress-info">
                    ...
                    <div class="timeline timeline-one-side">
                        <div class="timeline-block mb-3">
                            ...
                            <div class="timeline-content">
                                <h6 class="text-dark text-sm font-weight-bold mb-0">MYR 2400, Design changes
                                </h6>
            ...
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <div class="copyright text-center text-sm text-muted text-lg-start">
                        ...
                        <a href="#" class="font-weight-bold" target="_blank">Kollect</a>
